...
T = {
    "en": {
        ...
        "comp_title_ref_radius": "Reference (Radius {radius}km)",
        "config_title": "Configuration",
        "dev_credit": f"Developed by Dr. Markus Brosch (DL1MKS) | Programmed by Google Gemini<br><i>Release {APP_VERSION} | License: <a href='https://github.com/markusthemaker/WSPRadar/blob/main/LICENSE' target='_blank' style='color:#39ff14; text-decoration:none;'>AGPLv3</a> | Data: <a href='{DB_URL}' style='color:#39ff14; text-decoration:none;'>wspr.live</a> | Repo: <a href='https://github.com/markusthemaker/WSPRadar/' target='_blank' style='color:#39ff14; text-decoration:none;'>GitHub</a></i>",
        ...
        "lbl_radius": "Reference Search Radius (km)",
        ...
        "opt_comp_radius": "Reference Radius (Local Average)",
        "opt_comp_buddy": "Reference Station (Buddy Test)",
        "opt_comp_self": "Hardware A/B-Test (Self-Test)",
        "err_self_test": "You entered your own callsign. Please use 'Hardware A/B-Test' mode.",
        "lbl_self_test_mode": "Test Setup (for callsign {callsign})",
        "err_loc_length": "Error: Both locators must be exactly 6 characters long for an RX Self-Test.",
    ...
    "de": {
        ...
        "comp_title_ref_radius": "Referenz (Radius {radius}km)",
        "config_title": "Konfiguration",
        "dev_credit": f"Entwickelt von Dr. Markus Brosch (DL1MKS) | Programmiert von Google Gemini<br><i>Release {APP_VERSION} | Lizenz: <a href='https://github.com/markusthemaker/WSPRadar/blob/main/LICENSE' target='_blank' style='color:#39ff14; text-decoration:none;'>AGPLv3</a> | Daten: <a href='{DB_URL}' style='color:#39ff14; text-decoration:none;'>wspr.live</a> | Repo: <a href='https://github.com/markusthemaker/WSPRadar/' target='_blank' style='color:#39ff14; text-decoration:none;'>GitHub</a></i>",
        ...
        "lbl_qth": "QTH Locator (4-6 Chars)",
        "lbl_radius": "Referenz-Suchradius (km)",
        ...
        "opt_comp_radius": "Referenz-Radius (Lokaler Durchschnitt)",
        ...
        "lbl_self_test_mode": "Test-Setup (für Rufzeichen {callsign})",
        "err_loc_length": "Fehler: Beide Locators müssen für den RX Self-Test exakt 6 Zeichen lang sein.",
